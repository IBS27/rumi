    ...
    >
      ...
      {!room ? (
        <main className="empty-state">
          ...
          <p>
            Bring in a room scan. Explore its shape, inspect your furniture, and
            make the measurements your own.
          </p>
        ...
        <>
          ...
          <main className="workspace-grid">
            <aside className="object-list">
              ...
              <div className="list-footer">
                ...
                <small>
                  Overall bounds, including any recesses. Measurements are scan
                  estimates.
                </small>
              </div>
            </aside>
            <section className="viewer-panel" aria-label="Room view">
              ...
              <div className="canvas-container">
                <Suspense
                  fallback={
                    <div className="viewer-fallback">Preparing your room…</div>
                  }
                >
                  <RoomViewer
                    room={room}
            ...
            {object ? (
              ...
              <aside className="inspector inspector-empty">
                ...
                <h2>A closer look</h2>
                <p>
                  Select furniture in the room or the list to see dimensions and
          ...
          <footer className="workspace-footer">
            <details>
              <summary>{room.capture.warnings.length} capture notes</summary>
